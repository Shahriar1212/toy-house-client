            ...
            <section className="text-gray-700 body-font overflow-hidden bg-white">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={img1} />
                                ...
                                <div className="flex ml-6 items-center">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <input type="number" id="quantity" name="quantity" className="w-16 py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                                        </div>
